...
public class OPathFilteredView extends ViewPart {
	...
	private void hookContextMenu() {
		...
		menuMgr.addMenuListener(new IMenuListener() {
			public void menuAboutToShow(IMenuManager manager) {
				OPathFilteredView.this.fillContextMenu(manager);
			}
		});
	...
	private void showMessage(String message) {
		MessageDialog.openInformation(viewer.getControl().getShell(), "OPath Results", message);
	}
	...
	public void setInput(Collection<Variable> filtered) {
		this.viewer.setInput(filtered);
	}
